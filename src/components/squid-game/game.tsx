...
const Game = () => {
  ...
  return (
    <div className="bg-orange-300 h-screen w-screen absolute">
      ...
      <Finish isGameOver={player.current.gameOver} allPlayerFinished={allFinished} />

      <Image className="absolute left-1/2 max-sm:left-1/3 z-50" src="/doll.png" alt="doll" width={150} height={150} />

      <Contestant x={player.current.x} y={player.current.y} name={player.current.name} gameOver={player.current.gameOver} />
